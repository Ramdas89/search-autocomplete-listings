...
export interface SearchAutocompletelistProps<T> {
  items: T[]
...
export default function SearchAutocompletelist<T>({
  items = [],
  ...
  return (
    <ThemeProvider theme={theme}>
      <StyledSearchAutocompletelist className={className}>
      ...
      </StyledSearchAutocompletelist>
    </ThemeProvider>
  )
}

const StyledSearchAutocompletelist = styled.div`
  position: relative;
